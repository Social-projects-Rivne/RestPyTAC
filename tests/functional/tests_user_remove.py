...
class TestRemoveUser(ApiTestBase):
    ...
    def test_remove_user(self):
        ...
        removed_user = self.delete_user(self.admin_token, UserToTest.login)
    ...
    def test_delete_without_name(self):
        ...
        removed_user = self.delete_user(self.admin_token, name_empty)
        self.assertEqual(200, removed_user.status_code)
    ...
    def test_delete_without_token(self):
        ...
        removed_user = self.delete_user(token_empty, UserToTest.login)
        self.assertEqual(200, removed_user.status_code)
    ...
    def test_user_delete_himself(self):
        ...
        removed_user = self.delete_user(token, UserToTest.login)
        get_answer = str(removed_user.json()['content'])
        self.assertEqual(200, removed_user.status_code)
    ...
    def test_user_token_delete_admin(self):
        ...
        removed_user = self.delete_user(token, DefaultUser.user)
        get_answer = str(removed_user.json()['content'])
        self.assertEqual(200, removed_user.status_code)
    ...
    def test_admin_token_not_right(self):
        ...
        removed_user = self.delete_user(invalid_token, UserToTest.login)
        get_answer = str(removed_user.json()['content'])
