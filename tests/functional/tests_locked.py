...
class TestLocked(ApiTestBase):
    ...
    def test_locked(self):
        """Test  functionality of locking user after 3 wrong password attempts (user should be locked)
        """
    ...
    def test_not_locked(self):
        """User should not be locked after 2 wrong password attempts (user should not be locked)
        """
    ...
    def test_manual_lock(self):
        """Test  functionality of locking users by manual command with admin token (user should be locked)
        """
    ...
    def test_manual_unlock(self):
        """Test  functionality of unlocking user by manual command with admin token (user should be unlocked)
        """
    ...
    def test_reset_locked_admin_token(self):
        """Test  functionality of unlocking all users with admin token (all users should be unlocked)
        """
    ...
    def test_locked_admins(self):
        """Test functionality of locking admins after 3 wrong password attempts (admin should be locked)
        """
    ...
    def test_not_locked_admin(self):
        """Admin should not be locked after 2 wrong password attempts (admin should not be locked)
        """
    ...
    def test_manual_lock_user_token(self):
        """Test  functionality of locking users by manual command with user token (user should not be locked)
        """
    ...
    def test_locking_unexisting_user(self):
        """Test  functionality of locking unexisting user (unexisting user should not be locked)
        """
    ...
    def test_get_locked_admins_user_token(self):
        """Discovering locked admins with user token (locked admins should not be displayed)
        """
    ...
    def test_get_locked_admins_empty_token(self):
        """Discovering locked admins with empty token (locked admins should not be displayed)
        """
    ...
    def test_get_locked_users_user_token(self):
        """Discovering locked users with user token (locked users should not be displayed)
        """
    ...
    def test_get_locked_users_empty_token(self):
        """Discovering locked users with empty token (locked users should not be displayed)
        """
